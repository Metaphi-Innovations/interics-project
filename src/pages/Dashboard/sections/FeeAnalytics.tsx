...
import { CHART_MARGIN_GROUPED_BARS, SECTION_CHART_ROW_SX, computeVerticalGroupedBarSize } from '../components/chartLayout'
      ...
      <Box sx={SECTION_CHART_ROW_SX}>
        ...
        >
          {({ scope, monthBuckets, chartHeight: h }) => {
            ...
            const groupedBarSize = computeVerticalGroupedBarSize(
              h,
              billingStack.length,
              { top: CHART_MARGIN_GROUPED_BARS.top, bottom: CHART_MARGIN_GROUPED_BARS.bottom },
            )
            return (
