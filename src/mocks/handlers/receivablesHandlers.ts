...
let invoices: Invoice[] = [
  {
    ...
    dueDate: '2025-12-12',
    lineItems: [
      makeLine('li-1', 'svc-1', 'Mobilization — Interior Design', '998391', 300000, 18, {
        milestoneId: 'cm-001',
        baselineServiceId: 'bs-001',
        lineSource: 'milestone',
      }),
      makeLine('li-2', 'svc-4', 'Site Supervision', '998391', 150000, 18, { lineSource: 'manual' }),
    ],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
  ...
  },
  {
    ...
    dueDate: '2026-01-07',
    lineItems: [makeLine('li-3', 'svc-2', 'Design Development', '998391', 300000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-02-13',
    lineItems: [makeLine('li-4', 'svc-3', 'Working Drawings', '998392', 120000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 500,
  ...
  },
  {
    ...
    dueDate: '2026-03-05',
    lineItems: [makeLine('li-5', 'svc-5', 'Civil Works', '995462', 80000, 12)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-04-05',
    lineItems: [
      makeLine('li-6', 'svc-1', 'Design Draft — Interior Design', '998391', 600000, 18, {
        milestoneId: 'cm-002',
        baselineServiceId: 'bs-001',
        lineSource: 'milestone',
      }),
  ...
  },
  {
    ...
    dueDate: '2026-04-21',
    lineItems: [makeLine('li-7', 'svc-2', 'Design Development', '998391', 250000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-04-24',
    lineItems: [makeLine('li-8', 'svc-4', 'Site Supervision', '998391', 180000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-05-02',
    lineItems: [makeLine('li-9', 'svc-3', 'Working Drawings', '998392', 90000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-05-04',
    lineItems: [makeLine('li-10', 'svc-1', 'Concept Design', '998391', 50000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-05-06',
    lineItems: [makeLine('li-11', 'svc-2', 'Design Development', '998391', 35000, 18)],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
    tdsDeducted: 0,
  ...
  },
  {
    ...
    dueDate: '2026-01-17',
    lineItems: [
      makeLine('li-12', 'svc-1', 'Concept package — Retail', '998391', 200000, 18),
    ],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
  ...
  },
  {
    ...
    dueDate: '2026-03-22',
    lineItems: [
      makeLine('li-13', 'svc-4', 'FF&E coordination', '998391', 240000, 18, { lineSource: 'manual' }),
    ],
    baseAmount: 0,
    gstAmount: 0,
    totalAmount: 0,
